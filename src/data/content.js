    ...
    subjects: {
      chinese: {
        ...
        items: [
          ...
          { title: '识字与写字', core: '会认约 800 字、会写约 300 字，掌握基本笔画与笔顺。', why: '识字是阅读与写作的前提，规范笔顺才能避免错别字。', scene: '读路牌包装、写自己的名字和生日贺卡、作业书写清晰不误判。' },
  ...
  2: {
    ...
    subjects: {
      chinese: {
        name: '语文',
        items: [
          { title: '部首查字法', core: '累计识字 1600+，学会用部首查字典独立识字。', why: '脱离“拼音拐杖”，具备自主识字能力的关键转折。', scene: '课外阅读遇生字自己查、写作时确认字怎么写。' },
